    ...
    ->add(match ($variant) {
        'outline' => match ($accent) {
            true => [
                ...
                'data-current:bg-accent dark:data-current:bg-white/[7%] data-current:border data-current:border-zinc-200 dark:data-current:border-transparent',
                'hover:text-accent dark:hover:text-white dark:hover:bg-white/[7%] hover:bg-zinc-800/5 ',
        ...
        default => match ($accent) {
            true => [
                'data-current:text-accent hover:data-current:text-secondary',
