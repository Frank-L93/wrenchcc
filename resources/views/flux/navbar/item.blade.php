...
$classes = Flux::classes()
    ...
    ->add(match ($accent) {
        true => [
            ...
            'data-current:text-accent hover:data-current:text-secondary hover:bg-primary hover:data-current:bg-primary',
            'data-current:after:bg-accent',
        ],
        false => [
            'hover:text-secondary ',
            'data-current:text-secondary hover:bg-primary',
            'data-current:after:bg-accent',
        ],
    })
    ;
